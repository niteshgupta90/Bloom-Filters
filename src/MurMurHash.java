...
public class MurMurHash implements Hash {
	 ...
	 */
	private long hash64(final byte[] data, int length) {
		return hash64(data, length, length);
	}
	 ...
	 * @return 64 bit hash of the given array
	 */
	private long hash64(final String text, int from, int length) {
		return hashCode(text.substring(from, from + length));
	}
